...
<div class="navbar-default sidebar" role="navigation" id="hidein">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="marriagecertificate1.jsp" target="mainframe"><i class="fa fa-dashboard fa-fw"></i><b>New Registration</b></a>
                        </li>
                        <li>
                            <a href="marriageedithome.jsp" target="mainframe"><i class="fa fa-bar-chart-o fa-fw"></i><b>Edit Information</b></a>
                            
                        </li>
                        <li>
                            <a href="datatablemarriage.jsp" target="mainframe"><i class="fa fa-table fa-fw"></i><b>View</b></a>
                        </li>
                        <li>
                            <a href="printmarriagehome.jsp" target="mainframe"><i class="fa fa-edit fa-fw"></i><b>Print</b></a>
                        </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </div>
