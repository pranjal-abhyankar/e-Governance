...
$(document).ready(function(){
	...
	<thead>
		<tr>
                        <th><font color ="black">Inward Type</font></th>
			<th><font color ="black">Reg Date</font></th>
			<th><font color ="black">Reg No</font></th>
			<th><font color ="black">Reg No</font></th>
			<th><font color ="black">Zone</font></th>
			<th><font color ="black">File Date</font></th>
			<th><font color ="black">File no</font></th>
			<th><font color ="black">Letter No</font></th>
			<th><font color ="black">Letter Reference</font></th>
		</tr>
                <tr>
...
<tr>
                        ...
                        <td width ="3%" ><%=rs.getString(2)%></td>
                        <td width ="3%" ><%=rs.getString(3)%></td>
			<td width ="5%"><%=rs.getString(4)%></td>
			<td width ="5%"><%=rs.getString(5)%></td>
			<td width ="5%"><%=rs.getString(10)%></td>
			<td width ="5%"><%=rs.getString(11)%></td>
			<td width ="1%"><%=rs.getString(12)%></td>
			<td width ="7%"><%=rs.getString(13)%></td>
		</tr>
