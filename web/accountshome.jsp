...
<div class="navbar-default sidebar" role="navigation" id="hidein">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="payment1.jsp" target="mainframe"><i class="fa fa-dashboard fa-fw"></i><b>New Payment Voucher</b></a>
                        </li>
                       <li>
			   <a href="printvoucherhome.jsp" target="mainframe"><i class="fa fa-dashboard fa-fw"></i><b>Print Voucher</b></a>
                	</li>
                         <div hidden="hidden">
							<li>
								<a class="icon icon-world" href="contra.jsp" target="button">Contra</a>
							</li>
							<li><a class="icon icon-world" href="salary.jsp" target="button">Salary</a></li>
							<li><a class="icon icon-world" href="view.jsp" target="button">View</a></li>
							</div>
                        <li>
                            <a href=".jsp"><i class="fa fa-table fa-fw"></i><b>View</b></a>
                        </li>
...
<iframe id="mainframe" name="mainframe" style="margin:0; width:100%; height:1500px; border:none; overflow:hidden;" scrolling="no" onload="AdjustIframeHeightOnLoad()"></iframe>
