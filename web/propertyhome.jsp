...
ul#levelshow
{
    ...
    $("#hidein").slideToggle("slow");
  });
            $("#level").click(function(){
    $("#levelshow").slideToggle("slow");
  });
...
<div class="navbar-default sidebar" role="navigation" id="hidein">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="propertydomnew.jsp" target="mainframe"><i class="fa fa-dashboard fa-fw"></i><b>New Registration</b></a>
                        </li>
                        <li>
                            <a href=".jsp" target="mainframe"><i class="fa fa-bar-chart-o fa-fw"></i><b>Edit Information</b></a>
                            
                        </li>
                        <li>
                            <a href=".jsp" target="mainframe" id="level"><i class="fa fa-table fa-fw"></i><b>View</b></a>
                            <ul class="nav" id="levelshow" hidden="">
                        <li>
                            <a href="propertydomnew.jsp" target="mainframe"><i class="fa fa-dashboard fa-fw"></i><b>Properties</b></a>
                        </li>
                        <li>
                            <a href=".jsp" target="mainframe"><i class="fa fa-bar-chart-o fa-fw"></i><b>Receipts</b></a>
                        ...
                        <li>
                            <a href="propertyreceipt1.jsp" target="mainframe"><i class="fa fa-edit fa-fw"></i><b>Receipt</b></a>
                        </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> संपत्ति कर
                            </li>
                        </ol>
                    </div>
                </div>
