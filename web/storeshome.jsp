...
<div class="navbar-default sidebar" role="navigation" id="hidein">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="addstores.jsp" target="mainframe"><i class="fa fa-dashboard fa-fw"></i><b>Add</b></a>
                        </li>
                        <li>
                            <a href="dispatchstores.jsp" target="mainframe"><i class="fa fa-bar-chart-o fa-fw"></i><b>Dispatch</b></a>
                            
                        </li>
                        <li>
                            <a href="viewstores.jsp" target="mainframe"><i class="fa fa-table fa-fw"></i><b>View</b></a>
                        </li>
                        <li>
                            <a href="setupstores.jsp" target="mainframe"><i class="fa fa-edit fa-fw"></i><b>Setup</b></a>
                        </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </div>
...
<iframe id="mainframe" name="mainframe" style="margin:0; width:100%; height:100%; border:none; overflow:hidden;" scrolling="yes" onload="AdjustIframeHeightOnLoad()"></iframe>
