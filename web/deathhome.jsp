...
<div class="navbar-default sidebar" role="navigation" id="hidein">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="deathcertificate1.jsp" target="mainframe"><i class="fa fa-dashboard fa-fw"></i><b>New Registration</b></a>
                        </li>
                        <li>
                            <a href="deathedithome.jsp" target="mainframe"><i class="fa fa-bar-chart-o fa-fw"></i><b>Edit Information</b></a>
                            
                        </li>
                        <li>
                            <a href="datatabledeath.jsp" target="mainframe"><i class="fa fa-table fa-fw"></i><b>View</b></a>
                        </li>
                        <li>
                            <a href="printdeathhome.jsp" target="mainframe"><i class="fa fa-edit fa-fw"></i><b>Print</b></a>
                        </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> मृत्यु प्रमाण पत्र
                            </li>
                        </ol>
                    </div>
                </div>
